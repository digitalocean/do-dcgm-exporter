# The top-level make file should declare dependencies on the respective tool recipes (e.g. $(GOIMPORTS)).
# - If the required tool (version) is not built/installed yet, make will make sure to build/install it.
# - The *_VERSION variables in this file contain the "default" values, but can be overwritten in the top level make file.

ifeq ($(strip $(shell go list -m)),github.com/digitalocean/do-dcgm-exporter)
